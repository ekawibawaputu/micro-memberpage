      ...
      .then((res) => {
        ...
        users.details().then((detail) => {
          ...
          const userCookie = {
            ...
            thumbnail: detail.data.user.avatar,
          };
        ...
        <form onSubmit={submit}>
          <div className=" flex flex-col mb-4">
            ...
            <input
              ...
              value={email}
              onChange={setState}
              className="bg-white focus:outline-none border px-4 md:px-6 py-3 w-full border-gray-600 focus:border-teal-500"
          ...
          <button
            type="submit"
            className="bg-orange-500 hover:bg-orange-400 transition-all duration-200 focus:outline-none shadow-inner text-white px-4 md:px-6 py-3 whitespace-nowrap mt-4 w-full"
          >
            Masuk
          </button>
        </form>
      ...
      <div className="hidden w-5/12 md:flex justify-end pt-24 pr-16">
        <div className="relative" style={{ width: 369, height: 440 }}>
          ...
          <div className="absolute w-full h-full -mb-8 -ml-8">
            <img src="/assets/images/tamara caem.jpg" alt="tamara" />
          </div>
          <div
