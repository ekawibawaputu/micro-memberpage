      ...
      >
        ...
        <ul className="main-menu mt-12">
          <li>
            <button
              className={[
                "nav-link relative flex items-center py-3 px-5 transition-all duration-200 text-indigo-500 hover:text-white active:text-white focus:outline-none w-full text-left",
              ].join(" ")}
              onClick={logout}
            >
              Logout
