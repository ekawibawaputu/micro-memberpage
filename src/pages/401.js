...
export default function Unauthenticated({
  ...
  return (
    <section className="h-screen flex flex-col items-center">
      ...
      <p className="text-lg text-gray-600 mt-4 mtb-8 lg:w-3/12 xl:2/12 mx-auto text-center">
        Seems like you do not have access for this page. We are sorry.
      </p>
      {external ? (
        <a
          className="bg-orange-500 hover:bg-orange-400 transition-all duration-200 focus:outline-none shadow-inner text-white px-4 md:px-6 py-3 whitespace-nowrap mt-5"
          href={fallbackUrl}
        >
